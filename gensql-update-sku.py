...
GenerateCoinSQL("LZDZPK.02", 2, 11000)
GenerateCoinSQL("LZDZPK.08", 8, 44000)
GenerateCoinSQL("LZDZPK.18", 18, 97000)
GenerateCoinSQL("LZDZPK.30", 30, 162000)
#31-35
GenerateCoinSQL("LZDZPK.31", 58, 313000)
GenerateCoinSQL("LZDZPK.32", 128, 730000)
GenerateCoinSQL("LZDZPK.34", 288, 1644000)
GenerateCoinSQL("LZDZPK.35", 588, 3355000)
GenerateCoinSQL("LZDZPK.36", 998, 5700000)
